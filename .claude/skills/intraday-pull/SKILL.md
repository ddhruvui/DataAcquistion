...
One pod, one fetcher, one folder. `src/fetch_intraday.py` pulls EODHD **1-minute**
...
Bundled scripts (they read `runpod/.env`; nothing is typed). `SK=.claude/skills/intraday-pull/scripts`:
